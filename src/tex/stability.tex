...
%\begin{tabular}{cc}
%\includegraphics[width=.45\columnwidth]{fig/forpaper_AVGrelativeALLs_Argentina} &
%\includegraphics[width=.45\columnwidth]{fig/forpaper_AVGrelativeALLs_Colombia} \\
 %%    \includegraphics[width=.23\textwidth]{forpaper_AVGrelativeALLs_Ecuador} &
 %%    \includegraphics[width=.23\textwidth]{forpaper_AVGrelativeALLs_Mexico} \\
%(a) & (b) \\ %& (c) & (d) \\
%\end{tabular}
