...
\begin{figure*}[h]
  \centering
   \begin{tabular}{cc}
     \includegraphics[width=.45\textwidth]{forpaper_AVGrelativeALLs_Argentina.eps} &
     \includegraphics[width=.45\textwidth]{forpaper_AVGrelativeALLs_Colombia.eps} \\
...
\begin{figure}[h]
  \centering
    \includegraphics[width=0.8\textwidth]{forpaper_seasonalAVGrelativeALLs_Argentina.eps}
...
\begin{figure*}[h]
  \centering
   \begin{tabular}{cc}
     \includegraphics[width=.45\textwidth]{forPaper_absscorePerWeekAfterCorrection_avgsOfWeeks_Argentina.eps} &
     \includegraphics[width=.45\textwidth]{forPaper_absscorePerWeekAfterCorrection_avgsOfWeeks_Colombia.eps} \\
