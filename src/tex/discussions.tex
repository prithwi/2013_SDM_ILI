...
outperform those running on GFT. The only deviation could be seen in the case of Mexico,
but even here GST leads GFT slightly.

The only deviation could be seen in the case of Mexico, where the
